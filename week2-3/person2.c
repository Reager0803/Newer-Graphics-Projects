...
// ###########################################################
	...
	glTranslatef(6*sin(theta2), 0.0, 6*sin(theta2));

        glRotatef(theta[0], 1.0, 0.0, 0.0);             // Rotate object with respect to x axis
        glRotatef(theta[1], 0.0, 1.0, 0.0);             // Rotate object with respect to x axis
        glRotatef(theta[2], 0.0, 0.0, 1.0);             // Rotate object with respect to x axis

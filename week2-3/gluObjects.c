...
void Object(void) {
	...
	// Sphere
	//gluSphere(object1, 1.0, 100, 100);

	// Cone
	//gluCylinder(object1, 0.25, 0.5, 1.0, 20, 30);

	// Disk
	//gluDisk(object1, 0, 0.75, 40, 50);

	// Partial Disk
	gluPartialDisk(object1, 0.25, 1.0, 10, 12, 0.0, 180);
}
...
int main(int argc, char** argv) {
        ...
        glutCreateWindow("My GLU OBJECTS");
